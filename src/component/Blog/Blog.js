...
const Blog = () => {
    return (
        <div>
           <div className='w-8/12 border border-2 border-gray-600 p-5 rounded-md  ml-28 mt-10 bg-slate-100 text-center md:ml-60 t00'>
           ...
           <div className='w-8/12 border border-2 border-gray-600 p-5 mt-10 bg-slate-100 ml-28 text-center md:ml-60 t00'>
